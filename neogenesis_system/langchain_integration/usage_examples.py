...
from langchain.agents import initialize_agent, AgentType
from langchain.llms import OpenAI
from neogenesis_system.langchain_integration import get_all_neogenesis_tools
...
def example_langchain_chain_integration():
    ...
    try:
        ...
        from .chains import NeogenesisFiveStageChain, create_enhanced_neogenesis_chain
        
        print("📝 Neogenesis决策链使用示例:")
        chain_code = '''
# 方式1：使用预构建的Neogenesis决策链
from neogenesis_system.langchain_integration import NeogenesisFiveStageChain
...
from neogenesis_system.langchain_integration import create_enhanced_neogenesis_chain
...
def example_configuration_and_customization():
    ...
    config_code = '''
# 自定义配置示例
from neogenesis_system.langchain_integration import NeogenesisFiveStageDecisionTool
